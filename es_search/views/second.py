...
@csrf_exempt
def second(request):
    return render(request, 'search-para/second.html', {})


@csrf_exempt
def search_view_second(request):
    print request.GET
        ...
        body = {
            ...
            "query": {
                "multi_match": {
                    "query": str(keyword),
                    "type": "best_fields",
                    "fields": ["district", "zone", "zone_code", "full_name", "supply", "billing_address"],
                }
            }
        }
